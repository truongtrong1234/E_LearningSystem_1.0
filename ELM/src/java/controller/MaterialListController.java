...
public class MaterialListController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Material> materialList = mdao.getByLessonID(LessonID); 
        request.setAttribute("material", materialList);
        request.getRequestDispatcher("Learner/materialList.jsp").forward(request, response);
    }
