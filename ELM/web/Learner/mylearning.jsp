    ...
    <body>
        ...
        <main class="learning-container">
            ...
            <c:forEach var="course" items="${myLearningCourse}">
                <div class="course-card" onclick="toggle('chapters-${course.title}')">
                    ...
                    <div class="course-info">
                        <div style="display:flex; justify-content:space-between; align-items:center;">
                            ...
                            <span style="font-style:italic; color:#555;">Instructor: ${course.instructorName}</span>
                        </div>
...
<!--        <div class="chapters" id="chapters-${course.title}" 
 style="background:#f7f7f7; padding:10px 20px; border-radius:6px; margin-bottom:16px;">
            <c:forEach var="chapter" items="${course.chapters}">
                <div class="chapter" onclick="toggle('lessons-${chapter.title}')" 
