<%-- 
    Document   : login
    Created on : Oct 13, 2025, 7:51:44 PM
    Author     : Admin
--%>
...
&redirect_uri=http://localhost:8080/ELM/index.jsp
&response_type=code
&client_id=952221177325-4o9tk9nid7sgplqeejtrv9opbv57ugu3.apps.googleusercontent.com
&approval_prompt=force" class="btn bsb-btn-2xl btn-outline-dark rounded-0 d-flex align-items-center">
