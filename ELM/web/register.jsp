<%-- 
    Document   : register
    Created on : Oct 16, 2025, 9:08:23 AM
    Author     : Admin
--%>
        ...
        <div class="row gy-5 justify-content-center">
          ...
          <div class="col-12 col-lg-5 d-flex align-items-center">
            <div class="d-flex gap-3 flex-column w-100 ">
              <a href="https://accounts.google.com/o/oauth2/auth?scope=email profile openid &redirect_uri=http://localhost:8080/ELM/loginGoogle&response_type=code&client_id=952221177325-4o9tk9nid7sgplqeejtrv9opbv57ugu3.apps.googleusercontent.com&approval_prompt=force" class="btn btn-lg btn-danger">
