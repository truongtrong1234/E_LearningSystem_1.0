        ...
        <div class="d-flex">
            ...
            <div class="sidebar d-flex flex-column" id="sidebar">
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath}/instructor/analytics" class="nav-link text-white sidebar-link active">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-flex align-items-center ms-auto">
                            ...
                            <button class="btn btn-sm me-3 notification-btn" type="button">
                                <a href="${pageContext.request.contextPath}/notification" style="color: #495057">
                                    <i class="fas fa-bell"></i>
                                </a>
                            </button>
                            <button class="btn btn-sm me-3 notification-btn" type="button">
                                <a href="${pageContext.request.contextPath}/myProfile" style="color: #495057">
                ...
                <div class="container-fluid p-4">                    
                    <div class="row g-4">
                        <div class="col-md-4">
                            <div class="card p-3 text-center">
                                ...
                                <h3 class="text-success fw-bold">${totalLearners}</h3>
                            </div>
                        </div>
                        <div class="col-md-4">  
                            <div class="card p-3 text-center">
                                <h5 class="card-title mt-2">Số khóa học</h5>
                    ...
                    <div class="mt-5">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <c:forEach var="progress" items="${studentList}">
                                    <tr>
                                        <td>${progress.studentName}</td>
                                        <td>${progress.courseName}</td>
                                        <c:choose>
                                            <c:when test="${empty progress.completedPercent}">
                                                <td>Không ghi lại tiến độ </td>
                                            </c:when>
                                            <c:otherwise><td>${progress.completedPercent}</td></c:otherwise>
                                        </c:choose>
                                    </tr>
                                </c:forEach>
                            </tbody>
