...
<c:choose>
                    ...
                    <div class="card border-warning">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-center">
                                <a href="/ELM/instructor/quizList" class="btn btn-secondary fw-bold">
                                    Go Back
                                </a>
                            </div>
                        </div>
    ...
    <c:when test="${actionQuizs eq 'checkQuiz'}">
                        ...
                        <table class="table table-hover align-middle">
                            <thead class="table-dark">
                                <tr>
                                    ...
                                    <th>Số câu đúng</th>
                                    <th>Tổng điểm</th>
                                    <th class="text-center">Ngày làm bài</th>
                                </tr>
                            </thead>
                            <tbody>
                                <c:forEach var="q" items="${listProgress}" varStatus="loop">
                                    <tr>
                                        <td>${loop.index + 1}</td>
                                        <td>${q.accountName}
                                        </td>
                                ...
                                <c:forEach var="q" items="${quizList}" varStatus="loop">
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="/ELM/instructor/quizList?actionQuiz=checkQuiz&ChapterID=${q.chapterID}&quizID=${q.quizID}" 
                                               class="btn btn-view btn-sm btn-outline-warning me-2">
                                                <i class="fas fa-edit"></i> Xem điểm học viên
                                            </a>
