...
-- 4️⃣ Bảng khóa học, danh mục, tài khoản
DELETE FROM Courses;
...
DBCC CHECKIDENT ('ChapterProgress', RESEED, 0);
DBCC CHECKIDENT ('MaterialProgress', RESEED, 0);
DBCC CHECKIDENT ('Reports', RESEED, 0);         -- 🆕 Thêm dòng này
DBCC CHECKIDENT ('ReportReplies', RESEED, 0);   -- 🆕 Và dòng này
GO
...
(N'Toán 10 - Đại số & Hình học', N'Khóa cơ bản Toán 10', 1, 2, 0.00, 'toan10.jpg', '10'),
(N'Toán 11 - Hình học', N'Hình học phẳng & không gian', 1, 2, 0.00, 'toan11.jpg', '11'),
(N'Toán 12 - Ôn thi THPT', N'Tổng ôn Toán 12', 1, 2, 0.00, 'toan12.jpg', '12'),
(N'Vật lý 11 - Điện học', N'Điện tĩnh, điện động', 2, 3, 0.00, 'ly11.jpg', '11'),
(N'Vật lý 12 - Dao động & Sóng', N'Dao động, sóng cơ', 2, 3, 0.00, 'ly12.jpg', '12'),
(N'Hóa học 12 - Vô cơ', N'Phản ứng vô cơ trọng tâm', 3, 4, 0.00, 'hoa12.jpg', '12'),
(N'Sinh học 11 - Di truyền', N'Gen, quy luật Mendel', 4, 4, 0.00, 'sinh11.jpg', '11'),
(N'Ngữ văn 12 - Tác phẩm trọng tâm', N'Phân tích văn học', 5, 3, 0.00, 'van12.jpg', '12'),
(N'Lịch sử 12 - Cận đại', N'Lịch sử thế giới & VN', 6, 3, 0.00, 'su12.jpg', '12'),
(N'Địa lý 12 - Khí hậu & Bản đồ', N'Địa lý tự nhiên & dân cư', 7, 2, 0.00, 'dia12.jpg', '12'),
(N'Tiếng Anh 12 - Luyện đề', N'Ngữ pháp, đọc hiểu', 8, 4, 0.00, 'eng12.jpg', '12'),
(N'Tin học 11 - Cơ bản', N'Tin học ứng dụng & lập trình cơ bản', 9, 2, 0.00, 'it11.jpg', '11');
GO
